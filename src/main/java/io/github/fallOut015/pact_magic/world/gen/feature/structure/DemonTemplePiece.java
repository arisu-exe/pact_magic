...
public class DemonTemplePiece extends TemplateStructurePiece {
    private final ResourceLocation templateLocation;
    private final Rotation rotation;
    private static final ResourceLocation STRUCTURE_LOCATION_DEMON_TEMPLE = new ResourceLocation(MainPactMagic.MODID, "demon_temple");

    public DemonTemplePiece(TemplateManager templateManager, CompoundNBT tag) {
        super(IStructurePieceTypePactMagic.DEMON_TEMPLE_PIECE, tag);
    ...
    public boolean postProcess(ISeedReader level, StructureManager structureManager, ChunkGenerator chunkGenerator, Random rand, MutableBoundingBox bb, ChunkPos chunkPos, BlockPos blockPos) {
        ...
        if (this.templateLocation.equals(STRUCTURE_LOCATION_DEMON_TEMPLE)) {
